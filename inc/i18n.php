...
function in_security_strings() {
    return [
        'en' => [
            ...
            'guard_card_charger_intro'   => '<strong>Charging:</strong> individually (USB-C), or use a docking station for simultaneous charging of up to 3 IN Guard 01 units.',
            ...
            'sense_card_spec_13_label' => 'Ideal For',
            'sense_card_spec_13_value' => 'Guard booths, gatehouses, monitoring and control rooms, critical infrastructure posts',
        ],
        'pl' => [
            // Nav / footer chrome
            'nav_home'              => 'Home',
            ...
            'guard_hardware_subtitle'     => 'Jedna stacja bazowa obsługuje do 200 trackerów, a zasięg na duże lub wymagające obiekty można rozszerzać o kolejne stacje. IN Guard jest obecnie działającym prototypem — jego ostateczna forma może zostać dopasowana do Twoich konkretnych wymagań.',
            ...
            'sense_point_2'      => '<strong>Bez kamer, bez urządzeń noszonych na ciele</strong> — tylko kompaktowa jednostka, która po cichu wykonuje swoje zadanie w tle.',
            ...
            'chart_point_3'      => 'IN Sense automatycznie oznacza to jako <strong>stopniowany alert</strong> — najpierw dyskretny sygnał budzący, bez potrzeby, by przełożony wpatrywał się w ekran.',
            'chart_footnote_text' => 'IN Sense można zainstalować w dowolnym stałym posterunku — portierni, budki lub pomieszczenia dozoru — bez zakłócania sposobu, w jaki dotychczas pracuje Twój zespół.',
            ...
            'outcome_2_content'  => 'Pominięty punkt kontrolny jest oznaczany natychmiast. Na stałym posterunku nagły ruch, szarpanina lub podejrzenie upadku wywołuje natychmiastowy alert.',
            'outcome_3_title'    => 'Mądrzejsze decyzje kadrowe',
            'outcome_3_content'  => 'Rzeczywiste dane z obchodów — nie domysły — pokazują, gdzie dodać pokrycie, a gdzie skrócić trasy, zwiększając efektywność bez powiększania zespołu.',
            'outcome_4_title'    => 'Pełna anonimowość',
            'outcome_4_content'  => 'Bez kamer, bez analizy obrazu — w obu narzędziach strażnicy są monitorowani pod kątem obecności i czujności, nigdy obserwowani ani nagrywani jak na wideo.',
            'outcome_5_title'    => 'Jedna platforma, gotowa na rozbudowę',
            'outcome_5_content'  => 'Alerty z IN Sense i dane z obchodów IN Guard mogą trafiać do tego samego Centrum Sterowania, które można też zintegrować z innymi systemami bezpieczeństwa.',
            'outcome_6_title'    => 'Mniejsza rotacja pracowników',
            'outcome_6_content'  => 'Przycisk SOS i detekcja upadku dają strażnikom stałe poczucie bezpieczeństwa w pracy — wsparcie, które pomaga zatrzymać dobrych pracowników na stanowisku.',
            ...
            'guard_card_spec_3_value'  => 'Pochodzi bezpośrednio z GNSS — precyzyjny, zsynchronizowany satelitarnie czas przy każdym zapisanym punkcie, wykorzystywany do analityki zamiast czasu odbioru przez serwer',
            ...
            'guard_card_spec_6_value'  => 'Do 8 godzin ciągłych obchodów',
            ...
            'guard_card_spec_10_value' => 'Kieszeń użytkownika lub zaczepiony na smyczy; unikać ekranowania metalem dla najlepszego sygnału',
            ...
            'guard_card_spec_13_value' => 'Serwowane w pełni offline — bez potrzeby połączenia z internetem',
            'guard_card_spec_14_label' => 'Weryfikacja punktów kontrolnych',
            'guard_card_spec_14_value' => 'Każda wizyta automatycznie klasyfikowana jako wcześniejsza, na czas, spóźniona lub pominięta',
            ...
            'guard_card_charger_intro'   => '<strong>Ładowanie:</strong> pojedynczo (USB-C) albo za pomocą stacji dokującej do jednoczesnego ładowania do 3 urządzeń IN Guard 01.',
            ...
            'sense_card_spec_12_label' => 'Plany integracji',
            'sense_card_spec_12_value' => 'Predykcja zmęczenia i profilowanie zachowań oparte na uczeniu maszynowym',
            'sense_card_spec_13_label' => 'Idealne dla',
            'sense_card_spec_13_value' => 'Budek ochroniarskich, portierni, pomieszczeń dozoru, posterunków infrastruktury krytycznej',
        ],
    ];
}
